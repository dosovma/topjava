...
public class JacksonObjectMapper extends ObjectMapper {
    ...
    private JacksonObjectMapper() {
        ...
        //https://stackoverflow.com/questions/42775127/ignoring-jackon-jsonproperty-access-for-unit-tests
        SimpleModule simpleModule = new SimpleModule();
        simpleModule.setMixInAnnotation(User.class, UserJTest.class);
